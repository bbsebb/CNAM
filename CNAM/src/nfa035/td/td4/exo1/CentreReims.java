 ...
 *
 */
public class CentreReims implements MenuAffectationEnseignant, MenuEtudiants, MenuInscription,
		MenuinscriptionEnseignant, MenuinscriptionUE {
	private static int nbetudiantmax = 100;
	private static int nbenseignantmax = 30;
	private static int nbUEmax = 10;
