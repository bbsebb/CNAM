...
public class Gestion {
	...
	public void afficheCommandes() {
		...
		for(Iterator<Entry<NumBon, Fiche>> i = commandes.entrySet().iterator();i.hasNext();) {
			...
			System.out.print("Commande num�ro: " +entree.getKey().toString() +" ---> ");
	...
	public static void menu11(Gestion g) {
		...
		while (afficheMenu) {
			...
			case 0:
				...
				break;
			case 1:
				System.out.println("Non impl�ment�");
				break;
			case 2:
				System.out.println("Non impl�ment�");
				break;
			case 3 :
				...
				while(i.hasNext()) {
					...
					if(g.getTab().get(iFiche).getNom().equals(entry.getValue().getNom())) {
						System.out.print("Commande num�ro: " +entry.getKey() +" ---> ");
	...
	public static void menu12(Gestion g) {
		...
		while (afficheMenu) {
			...
			case 2:
				g.afficheFiches();
				System.out.println("Quel client correspond la commande; entrer le num�ro associ�");
				int iFiche = sc3.nextInt()-1;
				System.out.println("Entrer le num�ro de la commande :");
				sc3.nextLine();
				...
				if(g.getCommandes().containsKey(new NumBon(str)))
					System.out.println("Le num�ro de commande " + str +" est d�j� utilis�");
				else {
					 DateTimeFormatter formatter = DateTimeFormatter.ofPattern("d/MM/yyyy");
					g.ajouteCommande(str,LocalDate.parse(date, formatter), g.getTab().get(iFiche));
					System.out.println("Commande enregistr�e");
				}
