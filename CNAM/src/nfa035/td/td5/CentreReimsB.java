 ...
 *
 */
public class CentreReimsB implements MenuAffectationEnseignant, MenuEtudiants, MenuInscription,
		MenuinscriptionEnseignant, MenuinscriptionUE {

	private static LinkedList<Etudiant> lesEtudiants;
	private static LinkedList<Enseignant>  lesEnseignants;
	private static LinkedList<UE>  lesUE;
	 ...
	 */
	public CentreReimsB() {
		lesEnseignants = new LinkedList<Enseignant>();
		lesEtudiants = new LinkedList<Etudiant>();
		lesUE = new LinkedList<UE>();
		nbetudiant = 0;
		nbenseignant = 0;
		nbue = 0;
	}
